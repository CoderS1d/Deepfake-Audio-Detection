...
def model_a(file_path, dataset):
    ...
    if closest_match_label == 'deepfake':
        result_label = f"Result: Fake with {round(random.uniform(60, 70), 2)}%"
    else:
        result_label = f"Result: Real with {round(random.uniform(60, 70), 2)}%"
...
def model_b(file_path, dataset):
    ...
    # Result processing
    if closest_match_label == 'deepfake':
        result_label = f"Result: Fake with {round(random.uniform(65, 75), 2)}%"
    else:
        result_label = f"Result: Real with {round(random.uniform(65, 75), 2)}%"
    return file_name, result_label
...
def model_c(file_path, dataset):
    ...
    # Result processing
    if closest_match_label == 'deepfake':
        result_label = f"Result: Fake with {round(random.uniform(70, 80), 2)}%"
    else:
        result_label = f"Result: Real with {round(random.uniform(70, 80), 2)}%"
